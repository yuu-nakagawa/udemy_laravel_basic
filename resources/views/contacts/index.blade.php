                ...
                <div class="p-6 text-gray-900 dark:text-gray-100"><br>
                    ...
                    <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <tbody>
                            @foreach($contacts as $contast)
                            <tr>
                                <td class="border-t-2 border-gray-200 px-4 py-3">{{ $contast->id }}</td>
                                <td class="border-t-2 border-gray-200 px-4 py-3">{{ $contast->name }}</td>
                                <td class="border-t-2 border-gray-200 px-4 py-3">{{ $contast->title }}</td>
                                <td class="border-t-2 border-gray-200 px-4 py-3 ">{{ $contast->created_at }}</td>
                                <td class="border-t-2 border-gray-200 px-4 py-3 "><a class="text-blue-500" href="{{ route('contacts.show', ['id' => $contast->id] )}}">詳細を見る</a></td>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
